...
(function(root, factory) {
	...
	if (typeof define === "function" && define.amd) {
		define(["jquery", "public/js/iscroll-zoom", "hammer", "lrz"], factory);
	} else if (typeof exports === "object") {
		module.exports = factory(require("jquery"), require("public/js/iscroll-zoom"), require("public/js/hammer"), require("lrz"));
	} else {
		root.bjj = root.bjj || {};
